...
export const AGENTS: AgentInfo[] = [
  ...
  { id: 'blockdrive-compliance', name: 'Parker', title: 'Chief Compliance Agent', department: 'compliance', color: 'agent-compliance', colorClass: 'bg-agent-compliance', prefix: '/compliance', apiType: 'B' },
  { id: 'blockdrive-legal', name: 'Casey', title: 'Chief Legal Agent', department: 'legal', color: 'agent-legal', colorClass: 'bg-agent-legal', prefix: '/legal', apiType: 'B' },
  { id: 'blockdrive-sales', name: 'Sam', title: 'Chief Sales Agent', department: 'sales', color: 'agent-sales', colorClass: 'bg-agent-sales', prefix: '/sales', apiType: 'B' },
];
